 ...
 */
app.controller('ChatsCtrl', function ($scope, $rootScope, localStorageService, $http, $state, userService, dateService,  $stateParams,Upload, $timeout,ChatService,departmentAndPersonsService,localToolService
